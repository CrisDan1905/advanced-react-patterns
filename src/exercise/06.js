...
function useControlledSwitchWarning(controlPropValue, controlPropName, componentName) {
  ...
  const {current: componentWasControlled} = React.useRef(isControlled)
  React.useEffect(() => {
    if(process.env.NODE_ENV !== 'production') {
      warning(
        !(isControlled && !componentWasControlled),
  ...
  }, [isControlled, componentWasControlled, controlPropName, componentName])
