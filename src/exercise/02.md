...
`React.cloneElement` is required because React doesn't allow to modify property of children elements of a React element.
The way to do that is with `React.cloneElement`
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=02%3A%20Compound%20Components&em=danilo1905%40outlook.com).
